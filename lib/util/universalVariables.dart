...
class UniversalVariables {
  ...
  // static bool cameFromViewItineraryPage = false;
  //
  // static var planUserId;
  // static var planUserEmail;
  // static var planTitle;
  // static var planPrice;
  // static var planImage;
  // static var planDescription;
  // static var planInternalUsers = [];
  // static var planExternalUsers = [];
  // static var planPlaces =[];
  // static var planStatus = "Planning";
  // static var planFavorite = false;
  // static var planFavoriteTime = "";
  // static var planCurrentId = "";
  //
  // static var allPlans = [];
  //
  // static var numberOfPlansOfCurrentUser = 0;
  // static var showedAlertAtLocationPage = false;
  // static var minRadius = 100.0;
